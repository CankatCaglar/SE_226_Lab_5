...
def passGen(user_number):
    ...
    while user_number < 3 or user_number > 7:
        user_number = int(input("Invalid value!. Enter a number between 3 and 7: "))
...
user_number = int(input("Enter a number between 3 and 7 inclusively: "))
...
if initial_password:
    ...
    new_password = rep_with_upper(initial_password)
    print("Password after rep_with_upper: ", new_password)
...
# Question3
    ...
    def search_letter(source, key_letter):
        return key_letter in source

    user_number = 0

    search_result = search_letter(final_password, input("Please enter your name's first letter: "))
